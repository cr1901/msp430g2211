...
impl W {
    ...
    #[doc = "Bits 0:7 - Port 2 Selection register"]
    #[inline(always)]
    pub fn p2sel(&mut self) -> P2SEL_W<0> {
        P2SEL_W::new(self)
    }
    #[doc = "Bit 1 - P1"]
    #[inline(always)]
