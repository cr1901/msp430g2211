...
pub type P0_W<'a, const O: u8> = crate::BitWriter<'a, u8, P2OUT_SPEC, bool, O>;
...
impl W {
    ...
    #[doc = "Bits 0:7 - Port 2 Output register"]
    #[inline(always)]
    pub fn p2out(&mut self) -> P2OUT_W<0> {
        P2OUT_W::new(self)
    }
    #[doc = "Bit 1 - P1"]
    #[inline(always)]
