...
pub type P0_W<'a, const O: u8> = crate::BitWriter<'a, u8, P2DIR_SPEC, bool, O>;
...
impl W {
    ...
    #[doc = "Bits 0:7 - Port 2 Direction register"]
    #[inline(always)]
    pub fn p2dir(&mut self) -> P2DIR_W<0> {
        P2DIR_W::new(self)
    }
    #[doc = "Bit 1 - P1"]
    #[inline(always)]
