...
pub type P0_W<'a, const O: u8> = crate::BitWriter<'a, u8, P2IES_SPEC, bool, O>;
...
impl W {
    ...
    #[doc = "Bits 0:7 - Port 2 Interrupt Edge Select register"]
    #[inline(always)]
    pub fn p2ies(&mut self) -> P2IES_W<0> {
        P2IES_W::new(self)
    }
    #[doc = "Bit 1 - P1"]
    #[inline(always)]
