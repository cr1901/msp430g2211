...
impl W {
    ...
    #[doc = "Bits 0:7 - Port 1 Selection register"]
    #[inline(always)]
    pub fn p1sel(&mut self) -> P1SEL_W<0> {
        P1SEL_W::new(self)
    }
    #[doc = "Bit 1 - P1"]
    #[inline(always)]
