...
pub type P2CA_R = crate::FieldReader<u8, P2CA_A>;
...
pub type P2CA_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, CACTL2_SPEC, u8, P2CA_A, 5, O>;
impl<'a, const O: u8> P2CA_W<'a, O> {
