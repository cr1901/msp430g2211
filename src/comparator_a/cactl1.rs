...
pub type CAIFG_W<'a, const O: u8> = crate::BitWriter<'a, u8, CACTL1_SPEC, bool, O>;
...
pub type CAIE_W<'a, const O: u8> = crate::BitWriter<'a, u8, CACTL1_SPEC, bool, O>;
...
pub type CAIES_W<'a, const O: u8> = crate::BitWriter<'a, u8, CACTL1_SPEC, bool, O>;
#[doc = "Field `CAON` reader - Comp. A enable"]
pub type CAON_R = crate::BitReader<bool>;
#[doc = "Field `CAON` writer - Comp. A enable"]
pub type CAON_W<'a, const O: u8> = crate::BitWriter<'a, u8, CACTL1_SPEC, bool, O>;
...
pub type CAREF_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, CACTL1_SPEC, u8, CAREF_A, 2, O>;
...
pub type CARSEL_W<'a, const O: u8> = crate::BitWriter<'a, u8, CACTL1_SPEC, bool, O>;
...
pub type CAEX_W<'a, const O: u8> = crate::BitWriter<'a, u8, CACTL1_SPEC, bool, O>;
impl R {
