...
pub type BCSCTL1_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, BCSCTL1_SPEC, u8, u8, 8, O>;
#[doc = "Field `RSEL` reader - Range Select Bit 0"]
pub type RSEL_R = crate::FieldReader<u8, u8>;
#[doc = "Field `RSEL` writer - Range Select Bit 0"]
pub type RSEL_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, BCSCTL1_SPEC, u8, u8, 4, O>;
