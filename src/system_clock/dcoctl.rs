...
pub type DCOCTL_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, DCOCTL_SPEC, u8, u8, 8, O>;
#[doc = "Field `MOD` reader - Modulation Bit 0"]
pub type MOD_R = crate::FieldReader<u8, u8>;
#[doc = "Field `MOD` writer - Modulation Bit 0"]
pub type MOD_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, DCOCTL_SPEC, u8, u8, 5, O>;
#[doc = "Field `DCO` reader - DCO Select Bit 0"]
pub type DCO_R = crate::FieldReader<u8, u8>;
#[doc = "Field `DCO` writer - DCO Select Bit 0"]
pub type DCO_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, DCOCTL_SPEC, u8, u8, 3, O>;
impl R {
